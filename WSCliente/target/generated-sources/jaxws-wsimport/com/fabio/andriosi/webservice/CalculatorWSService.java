 ...
 * 
 */
@WebServiceClient(name = "CalculatorWSService", targetNamespace = "http://webservice.andriosi.fabio.com/", wsdlLocation = "http://localhost:8080/WebService/CalculatorWSService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWSSERVICE_QNAME = new QName("http://webservice.andriosi.fabio.com/", "CalculatorWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebService/CalculatorWSService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://webservice.andriosi.fabio.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.andriosi.fabio.com/", "CalculatorPort"), Calculator.class, features);
    }
